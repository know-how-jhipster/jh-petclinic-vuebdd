...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.vuebdd.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.vuebdd.security.DomainUserDetailsService", "createSpringSecurityUser");
