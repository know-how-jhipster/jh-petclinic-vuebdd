...
@Configuration
@EnableR2dbcRepositories({ "dev.knowhowto.jh.petclinic.vuebdd.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("dev.knowhowto.jh.petclinic.vuebdd.repository.search")
